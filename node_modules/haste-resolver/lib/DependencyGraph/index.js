...
var getPlatformExtension = require('../utils/getPlatformExtension');
...
var ResolutionResponse = require('./ResolutionResponse');
var HasteMap = require('./HasteMap');
var DeprecatedAssetMap = require('./DeprecatedAssetMap');
...
var DependencyGraph = (function () {
  function DependencyGraph(_ref) {
    ...
    var _ref$shouldThrowOnUnresolvedErrors = _ref.shouldThrowOnUnresolvedErrors;
    var shouldThrowOnUnresolvedErrors = _ref$shouldThrowOnUnresolvedErrors === undefined ? function () {
      return true;
    } : _ref$shouldThrowOnUnresolvedErrors;
  ...
  _createClass(DependencyGraph, [{
    ...
    value: function getDependencies(_ref2) {
      ...
      return this.load().then(function () {
        ...
        var absPath = path.resolve(entryPath);
