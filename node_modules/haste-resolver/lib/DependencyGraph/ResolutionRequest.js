      ...
      return this._getAllMocks(mocksPattern).then(function (allMocks) {
        ...
        var collect = function collect(mod) {
          return getDependencies(mod, transformOptions).then(function (depNames) {
            ...
            var depNames = _ref32[0];
            var dependencies = _ref32[1];
            ...
            var depNames = _ref42[0];
            var dependencies = _ref42[1];
            ...
            var newDependencies = filteredPairs.filter(function (_ref5) {
            ...
            return Promise.all(newDependencies.map(function (_ref6) {
              var _ref62 = _slicedToArray(_ref6, 2);

              var depName = _ref62[0];
              var modDep = _ref62[1];
    ...
    value: function _loadAsFile(potentialModulePath, fromModule, toModule) {
      ...
      return Promise.resolve().then(function () {
        if (_this6._helpers.isAssetFile(potentialModulePath)) {
          ...
          var _name = _getAssetDataFromName.name;
          var type = _getAssetDataFromName.type;

          var pattern = '^' + _name + '(@[\\d\\.]+x)?';
