...
var ResolutionResponse = (function () {
  ...
  _createClass(ResolutionResponse, [{
    ...
    value: function copy(properties) {
      var _properties$dependencies = properties.dependencies;
      var dependencies = _properties$dependencies === undefined ? this.dependencies : _properties$dependencies;
      var _properties$mainModuleId = properties.mainModuleId;
      var mainModuleId = _properties$mainModuleId === undefined ? this.mainModuleId : _properties$mainModuleId;
