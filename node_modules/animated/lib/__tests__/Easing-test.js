...
it('should ease '+type,function(){var _type$split=
type.split('_');var _type$split2=_slicedToArray(_type$split,3);var modeName=_type$split2[0];var easingName=_type$split2[1];var isFunction=_type$split2[2];
